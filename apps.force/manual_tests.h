...
#define JET_TESTS(testSetName)                                                                             \
    ...
    protected:                                                                                             \
        ...
        void saveData(const ConstArrayAccessor3<T>& data, const std::string& name) {                       \
            std::string filename = getFullFilePath(name);                                                  \
            std::vector<size_t> dim = {static_cast<unsigned int>(data.depth()),                            \
        ...
        std::string getResourceFileName(const std::string& name) {                                         \
            return pystring::os::path::join("./assets/Models", name);                                      \
        }                                                                                                  \
    };
