...
CustomScalarField2::CustomScalarField2(const std::function<double(const Point2D &)> &customFunction,
...
CustomScalarField2Ptr CustomScalarField2::Builder::makeShared() const {
    if (_customLaplacianFunction) {
        return std::shared_ptr<CustomScalarField2>(
                new CustomScalarField2(_customFunction, _customGradientFunction, _customLaplacianFunction),
                [](CustomScalarField2 *obj) { delete obj; });
    } else {
        return std::shared_ptr<CustomScalarField2>(
                new CustomScalarField2(_customFunction, _customGradientFunction, _resolution),
                [](CustomScalarField2 *obj) { delete obj; });
    }
}
