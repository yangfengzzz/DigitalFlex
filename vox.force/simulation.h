...
public:
    ...
    inline unsigned int numberOfPointSets() const {
        return static_cast<unsigned int>(m_neighborhoodSearch->n_point_sets());
    }

    inline unsigned int numberOfNeighbors(const unsigned int pointSetIndex,
    ...
    inline unsigned int getNeighbor(const unsigned int pointSetIndex,
                                    const unsigned int neighborPointSetIndex,
    ...
    inline const unsigned int* getNeighborList(const unsigned int pointSetIndex,
                                               const unsigned int neighborPointSetIndex,
                                               const unsigned int index) const {
