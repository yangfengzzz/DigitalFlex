...
Collider3::Collider3() = default;

Collider3::~Collider3() = default;

void Collider3::resolveCollision(double radius,
    ...
    if (isPenetrating(colliderPoint, *newPosition, radius)) {
        ...
        Point3D targetPoint = colliderPoint.point + radius * targetNormal;
...
bool Collider3::isPenetrating(const ColliderQueryResult& colliderPoint, const Point3D& position, double radius) {
