...
#include "vox.force/level_set_solver3.h"
...
public:
    ...
    //! Default destructor.
    ~IterativeLevelSetSolver3() override;
...
private:
    ...
    [[nodiscard]] double pseudoTimeStep(const ConstArrayAccessor3<double>& sdf, const Vector3D& gridSpacing) const;
};
