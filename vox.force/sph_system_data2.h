...
public:
    ...
    [[nodiscard]] double sumOfKernelNearby(const Point2D& position) const;
    ...
    //! (SphSystemData2::buildNeighborSearcher) before calling this function.
    //!
    [[nodiscard]] double interpolate(const Point2D& origin, const ConstArrayAccessor1<double>& values) const;
    ...
    //! (SphSystemData2::buildNeighborSearcher) before calling this function.
    //!
    [[nodiscard]] Vector2D interpolate(const Point2D& origin, const ConstArrayAccessor1<Vector2D>& values) const;
    ...
    //!
    [[nodiscard]] Vector2D gradientAt(size_t i, const ConstArrayAccessor1<double>& values) const;
    ...
    //! (SphSystemData2::buildNeighborLists) before calling this function.
    //!
    [[nodiscard]] Vector2D laplacianAt(size_t i, const ConstArrayAccessor1<Vector2D>& values) const;
