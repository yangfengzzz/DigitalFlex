...
#include "vox.force/collider_set2.h"
...
Vector2D ColliderSet2::velocityAt(const Point2D& point) const {
...
ColliderSet2::Builder ColliderSet2::builder() { return {}; }
...
ColliderSet2Ptr ColliderSet2::Builder::makeShared() const {
    return {new ColliderSet2(_colliders), [](ColliderSet2* obj) { delete obj; }};
}
