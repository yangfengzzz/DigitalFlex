...
#include "vox.force/level_set_solver2.h"
...
public:
    ...
    //! Default destructor.
    ~IterativeLevelSetSolver2() override;
...
private:
    ...
    [[nodiscard]] double pseudoTimeStep(const ConstArrayAccessor2<double>& sdf, const Vector2D& gridSpacing) const;
};
