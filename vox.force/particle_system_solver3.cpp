...
ParticleSystemSolver3::~ParticleSystemSolver3() = default;
...
void ParticleSystemSolver3::resolveCollision(ArrayAccessor1<Point3D> newPositions,
...
void ParticleSystemSolver3::timeIntegration(double timeStepInSeconds) {
    ...
    parallelFor(kZeroSize, n, [&](size_t i) {
        ...
        // Integrate position.
        Point3D& newPosition = _newPositions[i];
...
ParticleSystemSolver3::Builder ParticleSystemSolver3::builder() { return {}; }

ParticleSystemSolver3 ParticleSystemSolver3::Builder::build() const { return {_radius, _mass}; }

ParticleSystemSolver3Ptr ParticleSystemSolver3::Builder::makeShared() const {
    return {new ParticleSystemSolver3(_radius, _mass), [](ParticleSystemSolver3* obj) { delete obj; }};
}
